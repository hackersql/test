<div class="page-title">Register for an Account</div><br /><br />
			...
			$lValidationFailed = false;
		   	...
		   	switch ($_SESSION["security-level"]){
		   		...
		   		case "5": // This code is fairly secure
					...
					mysql_escape_string($mysignature) .
					"')";
					$lUsernameText = $Encoder->encodeForHTML($username);
		   		break;
		   	}// end switch

			$LogHandler->writeToLog("Added account: " . $username);				
		   	...
		   	if (!$lValidationFailed){
				...
				echo '<h1 class="success-message">Account created for ' . $lUsernameText . '</h1>';
