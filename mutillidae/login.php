...
<?php
	if ($_SESSION['loggedin']=="True") {
		echo "<script>var l_loggedIn = true;</script>";
	}else {
		echo "<script>var l_loggedIn = false;</script>";
	}// end if
?>
...
<!--
	<?php 
		if (isset($failedloginflag)){
			echo 'var l_failedLogInFlag = "'.$failedloginflag.'";';
		}else{
			echo 'var l_failedLogInFlag = "0";';
		}// end if
	?>
...
<div class="page-title">Login</div><br /><br />
<div id="id-log-in-form-div" style="display: none;">
