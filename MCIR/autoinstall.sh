...
sed "s/root/$username/" sqlol/includes/database.config.php.orig | sed "s/sudo !!/$password/" > sqlol/includes/database.config.php
sed "s/root/$username/" cryptomg/includes/db.inc.php.orig | sed "s/sudo !!/$password/" > cryptomg/includes/db.inc.php
