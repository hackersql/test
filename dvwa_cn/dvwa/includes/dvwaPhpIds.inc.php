...
function dvwaReadIdsLog() {
	...
	foreach ($file_array as $line_number => $line){
		...
		$data .= "<div id=\"idslog\"><b>日期/时间:</b> " . $datetime . "<br /><b>漏洞:</b> " . $vulnerability . "<br /><b>请求:</b> " . htmlspecialchars($request) . "<br /><b>参数:</b> " . htmlspecialchars($variable) . "<br /><b>IP:</b> " . $ip . "</div>";
	}
